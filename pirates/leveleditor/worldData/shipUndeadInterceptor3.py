        ...
        '1189043800.81gjeon': {
            ...
            'Objects': {
                '1255998720.0jubutler': {
                    ...
                    'Pause Chance': '100',
                    'Pause Duration': '30',
                    'Pos': Point3(1.5429999999999999, -17.163, 22.109999999999999),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'PropFXLeft': 'None',
                    'PropFXRight': 'None',
                ...
                '1255998848.0jubutler': {
                    ...
                    'Pause Chance': '100',
                    'Pause Duration': '30',
                    'Pos': Point3(18.012, 9.6300000000000008, 23.530999999999999),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                ...
                '1255998848.0jubutler0': {
                    ...
                    'Pause Chance': '100',
                    'Pause Duration': '30',
                    'Pos': Point3(-14.635999999999999, 3.6579999999999999, 23.536000000000001),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (0.65000000000000002, 0, 0, 1),
                ...
                '1255998848.0jubutler1': {
                    ...
                    'Pause Chance': '100',
                    'Pause Duration': '30',
                    'Pos': Point3(-12.938000000000001, -34.07, 22.155999999999999),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (0.65000000000000002, 0, 0, 1),
                ...
                '1255998848.0jubutler2': {
                    ...
                    'Pause Chance': '100',
                    'Pause Duration': '30',
                    'Pos': Point3(14.147, -35.881999999999998, 22.071000000000002),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (0.65000000000000002, 0, 0, 1),
...
extraInfo = {
    'camPos': Point3(-173.398, -66.250200000000007, 103.66200000000001),
    'camHpr': VBase3(-74.105800000000002, -20.5578, 0),
