...
# File: LauncherBase.pyc (Python 2.4)
...
class LauncherBase(DirectObject, ShowBase):
    GameName = 'game'
    ArgCount = 6
    LauncherPhases = [
        1,
    ...
    def __init__(self):
        ...
        self.setServerVersion(launcherConfig.GetString('server-version', 'pirates-rewritten-0.0.1'))
        ...
        if launcherConfig.GetBool('console-output', 1):
