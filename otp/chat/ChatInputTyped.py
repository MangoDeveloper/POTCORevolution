...
# File: pirates.chat.ChatInputTyped.pyc (Python 2.4)
...
class ChatInputTyped(FSM.FSM, DirectEntry):
    notify = DirectNotifyGlobal.directNotify.newCategory('ChatInputTyped')
    ExecNamespace = None
    
    def __init__(self, parent = None, **kw):
        FSM.FSM.__init__(self, 'ChatInputTyped')
        ...
        self.initialiseoptions(ChatInputTyped)
        self.whisperId = None
